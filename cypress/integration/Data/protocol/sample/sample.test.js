...
describe('Protocol Sample Page', () => {
  beforeEach(() => {
    cy.intercept('GET', '/data/protocol_samples/_search/*&sort=protocolName:asc&*', {fixture: 'protocol-samples.json'}).as("protocolSamplesList")
  ...
  it.only('should export data as CSV', () => {
