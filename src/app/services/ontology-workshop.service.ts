...
export class OntologyService {
  ...
  register(userData) {
    const url = validation_service_url + '/ontology_improver_workshop/register/';
  ...
  fetchZoomaMatches(terms: any) {
    const url = validation_service_url + '/ontology_improver_workshop/get_matches/';
  ...
  validateTerms(body: any) {
    const url = validation_service_url + '/ontology_improver_workshop/validate/';
  ...
  createUpdateOntologies(body: any) {
    const url = validation_service_url + '/ontology_improver_workshop/update_ontologies/';
    return this.http.post(url, body).pipe(
      map((data: any) => {
        return data;
      }),
